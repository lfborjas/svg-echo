...
{
	if (region.H.B === region.A.B)
	{
		return 'on line ' + region.H.B;
	}
	return 'on lines ' + region.H.B + ' through ' + region.A.B;
}
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{z: 0, A: elm$core$Maybe$Nothing, H: elm$core$Maybe$Nothing},
...
var author$project$Main$Drawing = 1;
...
var author$project$Main$drawMarker = F3(
...
var author$project$Main$drawEnd = function (_n0) {
	var end = _n0.A;
	if (end.$ === 1) {
...
var author$project$Main$onClickLocation = function (model) {
	return A2(
		elm$html$Html$Events$on,
		'click',
		A2(elm$json$Json$Decode$map, elm$core$Basics$identity, author$project$Main$positionDecoder));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Main$onClickLocation(model)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								author$project$Main$drawStart(model),
								author$project$Main$drawEnd(model)
							]))
					]))
			]),
		ak: 'SVG Echo'
...
var author$project$Main$main = elm$browser$Browser$document(
	{aw: author$project$Main$init, aC: author$project$Main$subscriptions, aD: author$project$Main$update, aF: author$project$Main$view});
